...
* Make sure you are using the latest GroupDocs.Comparison version before reporting an issue. See [GroupDocs.Comparison for .NET NuGet Package](https://www.nuget.org/packages/GroupDocs.Comparison/) to find out about the latest version.
